...
internal typealias AdjacencyList<V, E> = Map<CondensedVertex<V, E>, CondensedEdgeList<V, E>>
private typealias CondensedCut<V, E> = GraphCut<CondensedVertex<V, E>>
private typealias CondensedEdgeList<V, E> = List<CondensedEdge<V, E>>
private typealias CondensedVertexList<V, E> = List<CondensedVertex<V, E>>

class CondensedGraph<V : DDItem, E : GraphEdge<V>> internal constructor(
    override val vertices: CondensedVertexList<V, E>,
