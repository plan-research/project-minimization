package org.plan.research.minimization.plugin.compilation.gradle
...
import org.plan.research.minimization.plugin.compilation.exception.ParseKotlincExceptionResult
        ...
        withBackgroundProgress(context.indexProject, "Gradle building", cancellable = false) {
            reportSequentialProgress(5) { reporter ->
                try {
                    ...
                    ensure(cleanResult.exitCode == GradleConsoleRunResult.Companion.EXIT_CODE_OK) {
                    ...
                    ensure(buildResult.exitCode != GradleConsoleRunResult.Companion.EXIT_CODE_OK) { CompilationPropertyCheckerError.CompilationSuccess }
